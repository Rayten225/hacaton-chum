document.addEventListener('DOMContentLoaded', function() {
    ...
    orderForm.addEventListener('submit', function(event) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({order: orderDetails.order, price: orderDetails.price, deadline: orderDetails.deadline, organization: orderDetails.organization, FIO: orderDetails.FIO, number: orderDetails.number, address: orderDetails.address, email: orderDetails.email}),
